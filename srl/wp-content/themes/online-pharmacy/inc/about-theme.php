...
function online_pharmacy_get_bundle() {
	...
	?>
		<div class="wrap about-wrap">
			...
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 90+ Themes At 15% Discount. ', 'online-pharmacy' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 90+ Themes At 15% Discount use the coupon', 'online-pharmacy' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
