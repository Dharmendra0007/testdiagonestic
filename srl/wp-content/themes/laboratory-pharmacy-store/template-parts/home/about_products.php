...
?>
<?php if( get_theme_mod( 'laboratory_pharmacy_store_about_section_show_hide', true) != '') { ?>
<section id="abt-product" class="py-5">
  <div class="container">
    <?php if( get_theme_mod( 'laboratory_pharmacy_store_about_title' ) != '') { ?>
      <h2 class="mb-5"><?php echo esc_html( get_theme_mod('laboratory_pharmacy_store_about_title','')); ?></h2>
    <?php } ?>
    <div class="row">
      <?php
